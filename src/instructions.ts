...
export const instructions = [
  ...
  "- `antallAnsatte: null` means the register has no headcount (~96% of units), NOT zero employees. Check `antallAnsatte_reported`.",
  ...
  "- brreg holds no email and no phone. Those fields do not exist; `hjemmeside` is present ~9% of the time.",
